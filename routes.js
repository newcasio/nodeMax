...
const requestHandler = (req,res)=>{
  ...
  const url= req.url;
  //returns type of request eg get, post
...
};  //end requestHandler function


//parts of this overall file you want to be available elsewhere
//make object so exported things can be accessed individually 
module.exports = {
